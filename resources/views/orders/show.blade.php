  ...
  <div class="card-body">
    ...
    <div class="order-bottom">
      ...
      <div class="order-summary text-right">
        ...
        @endif
        <!-- 订单不是众筹订单，已支付，且退款状态「是未退」款时，展示申请退款按钮 -->
...
<script>
  $(document).ready(function() {
    ...
    $('.btn-select-installment').click(function () {
      // 调用创建分期付款接口
      axios.post('{{ route('payment.installment', $order->id) }}', {
